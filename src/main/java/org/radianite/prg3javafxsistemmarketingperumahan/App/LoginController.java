...
public class LoginController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        ...
        fadeLabelLogin.setNode(labelLogin);
        ...
        fadeOut1.setDuration(Duration.seconds(1));
        ...
        SequentialTransition sequentialTransition = new SequentialTransition(
                fadeGambar2, fadeOut2, fadeGambar3, fadeOut3, fadeGambar4, fadeOut4
        );
        sequentialTransition.setCycleCount(SequentialTransition.INDEFINITE);

        // Set event handler to start sequentialTransition after parallelTransitionGroup ends
        parallelTransitionGroup.setOnFinished(event -> sequentialTransition.play());
